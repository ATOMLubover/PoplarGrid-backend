...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.ProcessApplicationRequest"
                        }
                    },
                    {
                        "type": "integer",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.ProcessInvitationRequest"
                        }
                    },
                    {
                        "type": "integer",
        ...
        "/projects": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "排序方式，0：按 ID 倒序，1：按 updated_at 倒序，默认按 ID 倒序",
                        "name": "sort",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "dtos.ProcessApplicationRequest": {
            "type": "object",
            "required": [
                "accept",
                "application_id"
        ...
        "dtos.ProjectBasic": {
            ...
            "properties": {
                ...
                "labors": {
                    "description": "补充的成员分工信息",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dtos.MemberLabor"
                    }
                },
                "legacy_id": {
                    "description": "历史遗留序号",
