...
// 根据成员 ID 获取成员的完整信息
func (s *MemberService) GetMemberInfoById(memberId uint) (*dbmodels.Member, error) {
	return s.membersRepo.SelectFullModelById(memberId)
}

// GetMemberInfoByNickname 获取成员信息
// 根据成员昵称获取成员的完整信息
func (s *MemberService) GetMemberInfoByNickname(nickname string) (*dbmodels.Member, error) {
	return s.membersRepo.SelectFullModelByNickname(nickname)
}

// GetAllMembers 获取所有成员信息
// 返回所有成员的完整信息
func (s *MemberService) GetAllMembers() ([]dbmodels.Member, error) {
